...
def main():
    ...
    train_log_dir = './q2p_logs/gradient_tape/' + current_time + "_TLQE_" + data_name + '/train'
    test_log_dir = './q2p_logs/gradient_tape/' + current_time + "_TLQE_" + data_name + '/test'
    ...
    for step in tqdm(range(max_train_steps)):
        ...
        if step % save_step == 0:
            general_checkpoint_path = "./q2p_logs/" + model_name +"_"+ str(total_step) +"_TLQE_"+ data_name +".bin"
